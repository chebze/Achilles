...
[IncomingMessage(228)]
public class GetAccountPreferencesMessage : IncomingMessage
{
    public GetAccountPreferencesMessage(MessageHeader header, string raw) : base(header, raw)
    {
    }
    ...
    {
        return new AccountPreferencesMessage(ctx);
    }
}
